      ...
      <div className="bg-[#14141a] rounded-2xl p-6 border border-white/5 text-left mb-8">
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center pt-4 border-t border-white/5">
            ...
            <span className="text-emerald-400 text-xl font-bold">{formatPrice(order.productPrice)}</span>
          </div>
      ...
      <div className="bg-[#1e1e26] rounded-2xl p-6 border border-white/5 text-left mb-8">
        ...
        <ol className="space-y-3 text-sm text-zinc-400">
          <li className="flex gap-3">
            <span className="w-6 h-6 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0 text-xs font-medium">1</span>
          ...
          <li className="flex gap-3">
            <span className="w-6 h-6 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0 text-xs font-medium">2</span>
            <span>Transfer sesuai total: <strong className="text-emerald-400">{formatPrice(order.productPrice)}</strong></span>
          </li>
          <li className="flex gap-3">
            <span className="w-6 h-6 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0 text-xs font-medium">3</span>
            <span>Kirim bukti transfer via WhatsApp untuk konfirmasi</span>
          </li>
          <li className="flex gap-3">
            <span className="w-6 h-6 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0 text-xs font-medium">4</span>
