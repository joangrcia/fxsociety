          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#1e1e26] rounded-xl border border-white/5 overflow-hidden">
              <div className="p-4 border-b border-white/5 flex justify-between items-center">
                ...
                <Link to="/orders" className="text-sm text-blue-400 hover:text-blue-300">Lihat Semua</Link>
              </div>
                  ...
                  pendingOrders.map(order => (
                    <div key={order.id} className="p-4 hover:bg-white/5 transition-colors">
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-blue-400 text-sm font-bold">{formatPrice(order.productPrice)}</span>
                      </div>
            ...
            <div className="bg-[#1e1e26] rounded-xl border border-white/5 overflow-hidden">
              <div className="p-4 border-b border-white/5 flex justify-between items-center">
                ...
                <Link to="/customers" className="text-sm text-blue-400 hover:text-blue-300">Lihat Semua</Link>
              </div>
              <div className="divide-y divide-white/5">
