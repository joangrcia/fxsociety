        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-400/10 text-slate-300 border border-slate-400/20">
                {product.type}
              </span>
            </div>
        ...
        {activeTab === 'download' && (
          <div className="space-y-8">
            <div className="text-center py-8">
              <div className="w-20 h-20 bg-slate-400/10 rounded-full flex items-center justify-center mx-auto mb-6 text-slate-400">
              ...
              <button className="px-8 py-3 bg-slate-500 text-white font-bold rounded-xl hover:bg-slate-400 transition-all shadow-lg shadow-slate-400/20 hover:scale-105">
                Download Sekarang
              </button>
            </div>
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="inline-flex items-center gap-2 text-slate-300 hover:text-slate-200 text-sm font-medium"
              >
            ...
            <div className="relative border-l border-white/10 ml-3 space-y-8">
              {product.updates.map((update, idx) => (
                <div key={idx} className="relative pl-8">
                  {/* Timeline Dot */}
                  <div className={`absolute -left-1.5 top-1.5 w-3 h-3 rounded-full border border-[#14141a] ${idx === 0 ? 'bg-slate-400' : 'bg-zinc-700'}`} />
