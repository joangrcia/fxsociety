    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {myProducts.map((product) => (
          <div 
            key={product.id}
            className="group bg-[#14141a] rounded-2xl border border-white/5 overflow-hidden hover:border-orange-500/20 hover:shadow-[0_8px_30px_rgba(0,0,0,0.3)] transition-all duration-300 flex flex-col"
          >
            {/* Image Area */}
            <div className="relative h-48 bg-[#0a0a0f] overflow-hidden">
              ...
              <div className="absolute top-3 left-3">
                 <span className={`
                   ...
                   ${product.type === 'Ebook' ? 'bg-blue-500/10 text-blue-400 border-blue-500/20' : ''}
              ...
              <div>
                {product.status === 'active' ? (
                  <div className="space-y-3">
                    <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-orange-600 text-white font-medium rounded-xl hover:bg-orange-500 transition-colors shadow-lg shadow-orange-500/20">
        ...
        {/* Empty State / Add New */}
        <Link to="/shop" className="group rounded-2xl border border-dashed border-white/10 bg-white/5 hover:bg-white/10 hover:border-orange-500/30 transition-all duration-300 flex flex-col items-center justify-center text-center p-8 min-h-[300px]">
          <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center text-zinc-500 group-hover:scale-110 group-hover:text-orange-400 transition-all mb-4">
